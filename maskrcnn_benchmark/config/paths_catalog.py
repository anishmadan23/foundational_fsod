...
class DatasetCatalog(object):
    DATASETS = {
        ...
        "nuim_val_dummy": {
            ...
            "ann_file": "nuimages/modified_annotations/no_wc/nuimages_dummy_v1.0-val.json"
        },
        "nuim_val": {
            "img_dir": "nuimages/images",
        ...
        "lvis05_train_fsod": {
            "img_dir": "coco/train2017",
            "ann_file": "coco/annotations/ffsod_detic_splits_with_crowd/lvis_shots.json",
            # "ann_file": "coco/annotations/lvis_v0.5_val.json",
            "is_train": True,
            "special_safeguard_for_coco_grounding": True,
            "exclude_crowd": True,
        },
        "lvis05_val_fsod": {
            "img_dir": "coco/val2017",
            # "ann_file": "coco/annotations/ffsod_detic_splits/lvis_v05_val.json",
            "ann_file": "coco/annotations/ffsod_detic_splits_with_crowd/lvis_v05_val.json",
            "is_train": True,
            "special_safeguard_for_coco_grounding": True,
            "exclude_crowd": True,
        ...
        # "lvis_v05_train_fsod": {
        #     "img_dir": "coco/val2017",
        #     "ann_file": "coco/annotations/lvis_v05_train_fsod.json"
        # },
        # "lvis_v05_val_fsod": {
        #     "img_dir": "coco/val2017",
        #     "ann_file": "coco/annotations/lvis_v05_val_fsod.json"
        # },
    }
    ...
    def get(name):
        ...
        if name.endswith('_bg'):
            ...
            if "voc" in name and 'split' in attrs:
                ...
                if name in ["object365_grounding_train", 'coco_grounding_train_for_obj365', 'lvis_grounding_train_for_obj365'] or 'lvis05' in name:
                    return dict(
                        factory="CocoGrounding_New",
                        args=args,
                    )
            ...
            elif "lvis_evaluation" in name or 'lvis05' in name:
                img_dir = try_to_find(attrs["img_dir"], return_dir=True)
                ann_dir = try_to_find(attrs["ann_file"], return_dir=True)
                args = dict(
                    img_folder=os.path.join(img_dir, attrs["img_dir"]),
