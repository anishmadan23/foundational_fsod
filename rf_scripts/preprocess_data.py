...
class PreprocessData:
    ...
    def get_clean_ann_data(self, data_ann_file):
        ...
        # just remove the category 0 as MQGLIP expects categories and annotations start from 1 and not 0
        new_data_ann['categories'] = [{'id': cat['id'], 'name': cat['name'], 'supercategory': cat['supercategory']} for cat in data_ann['categories'] if cat['id']!=0]
