...
def main(datasets_links_filepath, cmds_script_path):
    ...
    with open(cmds_script_path, 'w') as bash_script:
        ...
        for dataset in dataset_names:
            ...
            command = f"""python tools/extract_vision_query.py --config_file configs/pretrain/mq-glip-l.yaml --add_config_file configs/rf_configs/{dataset}/10_shots/multimodal_prompting.yaml --dataset roboflow_{dataset} --num_vision_queries 10 --save_path MODEL/rf_data/{dataset}_fsod_best_split/ --add_name large \n"""
...
if __name__=='__main__':
    ...
    cmds_script_path = 'rf_scripts/extract_vision_queries.sh'
