# Foundational FSOD - Multi-modal Queried Object Detection in the Wild
...
## My commands for nuimages
### Extract Vision Queries
```bash
...
### Run FT Free Evaluation based on Vision+Text
```bash
CUDA_VISIBLE_DEVICES=4,5,6,7 python -m torch.distributed.launch --master_port 8998 --nproc_per_node 4 tools/test_grounding_net.py \ 
--config-file configs/pretrain/my_configs/mq-glip-t-nuim.yaml \
--additional_model_config configs/vision_query_5shot/nuimages/nuimages_5_shots_seed0_fsod.yaml \
VISION_QUERY.QUERY_BANK_PATH MODEL/nuimages_fsod_5_shots_seed_0/nuim_fsod_query_5_pool7_sel_tiny.pth \
MODEL.WEIGHT MODEL/mq-glip-t \
TEST.IMS_PER_BATCH 4 OUTPUT_DIR results/nuimages/5_shots_seed_0/ VISION_QUERY.NUM_QUERY_PER_CLASS 5
```


### Run FT Free Eval w/o text
```bash
CUDA_VISIBLE_DEVICES=4,5,6,7 python -m torch.distributed.launch --master_port 8998 --nproc_per_node 4 tools/test_grounding_net.py \ 
--config-file configs/pretrain/my_configs/mq-glip-t-nuim.yaml \
--additional_model_config configs/vision_query_5shot/nuimages/nuimages_5_shots_seed0_fsod.yaml \
VISION_QUERY.QUERY_BANK_PATH MODEL/nuimages_fsod_5_shots_seed_0/nuim_fsod_query_5_pool7_sel_tiny.pth \
MODEL.WEIGHT MODEL/mq-glip-t \
TEST.IMS_PER_BATCH 4 OUTPUT_DIR results/nuimages/5_shots_seed_0_no_text/ VISION_QUERY.MASK_DURING_INFERENCE True VISION_QUERY.TEXT_DROPOUT 1.0 VISION_QUERY.NUM_QUERY_PER_CLASS 5
```

### Run FT Free Eval w/o vision queries
```bash
CUDA_VISIBLE_DEVICES=4,5,6,7 python -m torch.distributed.launch --master_port 8998 --nproc_per_node 4 tools/test_grounding_net.py \ 
--config-file configs/pretrain/my_configs/mq-glip-t-nuim.yaml \
--additional_model_config configs/vision_query_5shot/nuimages/nuimages_5_shots_seed0_fsod.yaml \
VISION_QUERY.QUERY_BANK_PATH MODEL/nuimages_fsod_5_shots_seed_0/nuim_fsod_query_5_pool7_sel_tiny.pth \
MODEL.WEIGHT MODEL/mq-glip-t \
TEST.IMS_PER_BATCH 4 OUTPUT_DIR results/nuimages/5_shots_seed_0_no_vq/
VISION_QUERY.ENABLED False VISION_QUERY.NUM_QUERY_PER_CLASS 5
```
