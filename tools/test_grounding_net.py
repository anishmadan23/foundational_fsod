...
def main():
    ...
    # logger.info("\n" + collect_env_info())
    model = build_detection_model(cfg)      #this goes into instantiating QuerySelector
                ...
                for output_folder, dataset_name, data_loader_val in zip(output_folders, dataset_names, data_loaders_val):
                    if args.extract_test_queries:
                        ...
                        inference(
                            ...
                            cfg=cfg_,
                            relabel_preds = cfg_.DATASETS.RELABEL_PREDS
                        )
        ...
        if log_dir:
            ...
            for output_folder, dataset_name, data_loader_val in zip(output_folders, dataset_names, data_loaders_val):
                if args.extract_test_queries:
                    ...
                    if cfg.VISION_QUERY.ENABLED and (cfg.VISION_QUERY.QUERY_BANK_PATH == "" or cfg.VISION_QUERY.OFFLINE_WITH_ONLINE):   # by default for lvis ft free cmd, VISION_QUERY.ENABLED is true and QUERY_BANK_PATH is specified in the command.
                    ...
                    inference(
                        ...
                        output_folder=output_folder,
                        cfg=cfg,
                        relabel_preds=cfg.DATASETS.RELABEL_PREDS
                    )
                    synchronize()
            # logger.info("FLOPs: {}, #Parameter: {}".format(params, flops))
